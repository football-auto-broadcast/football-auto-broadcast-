...
#define GDK_TYPE_SCROLL_RELATIVE_DIRECTION (gdk_scroll_relative_direction_get_type())
...
#define GDK_TYPE_TOPLEVEL_CAPABILITIES (gdk_toplevel_capabilities_get_type())
