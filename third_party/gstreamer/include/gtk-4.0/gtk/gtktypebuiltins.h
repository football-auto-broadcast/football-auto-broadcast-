...
GDK_AVAILABLE_IN_ALL GType gtk_accessible_platform_state_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_ACCESSIBLE_PLATFORM_STATE (gtk_accessible_platform_state_get_type ())

/* enumerations from "gtkaccessibletext.h" */
GDK_AVAILABLE_IN_ALL GType gtk_accessible_text_granularity_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_ACCESSIBLE_TEXT_GRANULARITY (gtk_accessible_text_granularity_get_type ())
GDK_AVAILABLE_IN_ALL GType gtk_accessible_text_content_change_get_type (void) G_GNUC_CONST;
...
GDK_AVAILABLE_IN_ALL GType gtk_dialog_error_get_type (void) G_GNUC_CONST;
...
GDK_AVAILABLE_IN_ALL GType gtk_list_tab_behavior_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_LIST_TAB_BEHAVIOR (gtk_list_tab_behavior_get_type ())
GDK_AVAILABLE_IN_ALL GType gtk_list_scroll_flags_get_type (void) G_GNUC_CONST;
...
GDK_AVAILABLE_IN_ALL GType gtk_accessible_announcement_priority_get_type (void) G_GNUC_CONST;
...
GDK_AVAILABLE_IN_ALL GType gtk_font_rendering_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_FONT_RENDERING (gtk_font_rendering_get_type ())
GDK_AVAILABLE_IN_ALL GType gtk_text_buffer_notify_flags_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_TEXT_BUFFER_NOTIFY_FLAGS (gtk_text_buffer_notify_flags_get_type ())
GDK_AVAILABLE_IN_ALL GType gtk_interface_color_scheme_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_INTERFACE_COLOR_SCHEME (gtk_interface_color_scheme_get_type ())
GDK_AVAILABLE_IN_ALL GType gtk_interface_contrast_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_INTERFACE_CONTRAST (gtk_interface_contrast_get_type ())
...
GDK_AVAILABLE_IN_ALL GType gtk_font_level_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_FONT_LEVEL (gtk_font_level_get_type ())

/* enumerations from "gtkgraphicsoffload.h" */
GDK_AVAILABLE_IN_ALL GType gtk_graphics_offload_enabled_get_type (void) G_GNUC_CONST;
...
GDK_AVAILABLE_IN_ALL GType gtk_collation_get_type (void) G_GNUC_CONST;
...
GDK_AVAILABLE_IN_ALL GType gtk_window_gravity_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_WINDOW_GRAVITY (gtk_window_gravity_get_type ())
